...
model_name = 'ResNet152V2_CL2_100'
model_to_load = "/user/2022_va_gr01/Francesco/models/ResNet152V2_CL2_100"
...
always_chekpoint = ModelCheckpoint(model_dir + '@', monitor="val_loss", save_freq='epoch')
